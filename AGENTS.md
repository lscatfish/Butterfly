...
### 当前表现 (k_clap=0.3, L/W=2.81, peak_θ=28.4°, mean_α_eff=50.8°) — v6.8 物理合理约束
...
DESIGN_v68 = {
    # 气动安装角 (物理合理范围: α_f ≤ 50°)
    "alpha_front_deg": 50,    # 前翅安装角 — 物理上限, 均值 α_eff=50.8°
    "alpha_back_deg": 8,      # 后翅安装角
    # 翅膀相位
    "phase_diff_deg": -20,    # 前后翅相位差
    # 机构参数
    "mech_a": 6.0,            # 曲柄半径 [mm]
    "mech_R": 2.50,           # 摇杆半径 [mm] — R=2.50 是关键
    ...
    "rotation": "cw",         # 曲柄转向
    # Clap-fling
    "k_clap": 0.3,            # k_max (50°下 kc=0.5 不稳定, 必须用 0.3)
}
# L/W=2.807, peak_θ=28.4°, mean_α_eff=50.8°, >70°%=3.1%, n_exceed_90=0

# 备选 — 更保守 (均值 α_eff=46°, Dickinson范围内):
DESIGN_v68_safe = {
    "alpha_front_deg": 45, "alpha_back_deg": 8, "phase_diff_deg": -10,
    "mech_a": 6.0, "mech_R": 2.50, "phi_offset_deg": -25,
    "f": 17, "c_damp": 5e-4, "rotation": "cw", "k_clap": 0.3,
}
# L/W=2.381, peak_θ=24.2°, mean_α_eff=46.0°, >70°%=2.0%

# 激进方案 (均值 α_eff=51°, 过渡区):
DESIGN_v68_R225 = {
    "alpha_front_deg": 50, "alpha_back_deg": 8, "phase_diff_deg": -20,
    "mech_a": 6.0, "mech_R": 2.25, "phi_offset_deg": -30,
    "f": 17, "c_damp": 5e-4, "rotation": "cw", "k_clap": 0.3,
}
# L/W=2.696, peak_θ=29.3°, mean_α_eff=50.9°, >70°%=3.1% (R=2.25 需验证)
```
